	...
	$.fn.bxSlider = function(options){		
		...
		this.goToNextSlide = function(stopAuto){
			...
			if(!options.infiniteLoop){
                ...
                var originalParentLeft = parseInt($parent.css('left'));
                    var leftWrongBy = originalParentLeft % parentLeft;
                    var changeLeft = leftWrongBy % childrenOuterWidth;

                    if (originalParentLeft % childrenOuterWidth != 0) {
                        if (slideLoop && (changeLeft != leftWrongBy)) {
                            parentLeft += changeLeft;
                        } else {
                            parentLeft += leftWrongBy;
                        }
                    }
